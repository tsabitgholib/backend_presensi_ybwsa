...
Route::middleware(['auth.jwt'])->group(function () {
    ...
    // Shift Detail
    Route::post('shift-detail/create', [ShiftController::class, 'storeShiftDetail']);
    ...
    Route::get('lauk-pauk/get-by-id/{id}', [\App\Http\Controllers\LaukPaukUnitController::class, 'show']);
